...
> 其他渠道不属于海文东标准，需要基于海文东标准渠道

  <Card title="Rococo_Gibbet" icon="seti:plan">
    【汐洛·绞架】绞架渠道，基于洛可可渠道，仅包括汐洛绞架，更新周期很长，适合喜欢小而美的用户。

    在 docker hub ，绞架渠道使用 `Rococo_Gibbet` 和 `R_G` 标签。

    版本号更新与洛可可渠道一致。
  </Card>
  <Card title="Rococo_Salvation" icon="seti:plan">
    【汐洛·救赎】救赎渠道，基于洛可可渠道，移除了汐洛绞架，更新周期很长，适合喜欢小而美的用户。

    在 docker hub ，救赎渠道使用 `Rococo_Salvation` 和 `R_S` 标签。
