const baseRoot = "./src/assets/template";
...
const scripts = {
    ...
    Clarity: /*html*/ `<!-- Start of Microsoft Clarity -->
...
const PAG = /*html*/ `<canvas class="canvas" id="tencent-pag" style="position:absolute;display:none;"></canvas>
