...
export function exAce() {
  ...
  window.__.ace.createEditor = async (id: string, initMode: string, initCode: string) => {
    ...
    return await Swal.fire({
      ...
      didOpen: (thisE) => {
        const _t = thisE.querySelector(".ace-container textarea") as HTMLElement;
        if (_t) {
          ...
          const _HTML_c = thisE.querySelector("#swal2-html-container") as HTMLElement;
          const _ace_c = _HTML_c.querySelector(".ace-container") as HTMLElement;
          const _ace_e = _ace_c.querySelector(".ace_editor") as HTMLElement;
          const _rule_line = thisE.querySelector(".ace_print-margin") as HTMLElement;
          const _s_fontsize = _ace_c.querySelector("#ace_fontsizeSelector") as HTMLSelectElement;
          const _s_mode = _ace_c.querySelector("#ace_modeSelector") as HTMLSelectElement;
          const _s_theme = _ace_c.querySelector("#ace_themeSelector") as HTMLSelectElement;
