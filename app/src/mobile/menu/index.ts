...
export const initRightMenu = () => {
    ...
    if (window.siyuan.user && !window.siyuan.config.readonly) {
        accountHTML = `<div class="b3-menu__item b3s-mobile-height-menu__item" id="menuAccount">
...
<div class="b3-menu__item b3s-mobile-height-menu__item${window.siyuan.config.readonly ? " fn__none" : " fn__none"}" id="menuNewNotebook">
...
<div id="menuNewDaily" class="b3-menu__item b3s-mobile-height-menu__item${window.siyuan.config.readonly ? " fn__none" : " fn__none"}">
...
<div class="b3-menu__item b3s-mobile-height-menu__item${window.siyuan.config.readonly ? " fn__none" : ""}" id="menuRiffCard">
...
<div class="b3-menu__item b3s-mobile-height-menu__item${window.siyuan.config.readonly ? " fn__none" : ""}" id="menuAI">
    <svg class="b3-menu__icon"><use xlink:href="#iconSparkles"></use></svg><span class="b3-menu__label">AI</span>
</div>
<div class="b3-menu__item b3s-mobile-height-menu__item${window.siyuan.config.readonly ? " fn__none" : ""}" id="menuAppearance">
...
<div id="menuSync" class="b3-menu__item b3s-mobile-height-menu__item${window.siyuan.config.readonly ? " fn__none" : ""}">
    <svg class="b3-menu__icon"><use xlink:href="#iconCloud"></use></svg><span class="b3-menu__label">${window.siyuan.languages.cloud}</span>
</div>
<div class="b3-menu__item b3s-mobile-height-menu__item" id="menuAbout">
