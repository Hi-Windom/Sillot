    ...
    bindEvent: () => {
        ...
        const setexprt = (pandocBin?: string) => {
            fetchPost("/api/setting/setExport", {
                ...
                blockRefMode: Number.parseInt((exportConfig.element.querySelector("#blockRefMode") as HTMLSelectElement).value, 10),
                blockEmbedMode: Number.parseInt((exportConfig.element.querySelector("#blockEmbedMode") as HTMLSelectElement).value, 10),
                fileAnnotationRefMode: Number.parseInt((exportConfig.element.querySelector("#fileAnnotationRefMode") as HTMLSelectElement).value, 10),
