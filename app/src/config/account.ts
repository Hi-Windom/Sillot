...
export const account = {
    ...
    genHTML: () => {
        ...
        let payHTML = `<a class="b3-button b3-button--big" href="https://ld246.com/subscribe/siyuan" target="_blank">
...
`;
        if ("" !== sponsor) {
            payHTML += `<a href="${sponsor}" target="_blank" class="b3-chip b3-chip--pink b3-chip--hover">
