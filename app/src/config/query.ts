        ...
        query.element.querySelectorAll("input").forEach((item) => {
            item.addEventListener("change", () => {
                fetchPost("/api/setting/setSearch", {
                    ...
                    limit: Number.parseInt((query.element.querySelector("#limit") as HTMLInputElement).value),
                    ...
                    backlinkMentionKeywordsLimit: Number.parseInt((query.element.querySelector("#backlinkMentionKeywordsLimit") as HTMLInputElement).value),
