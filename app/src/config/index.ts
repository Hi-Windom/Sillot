...
<div class="fn__flex-1 fn__flex config__panel">
  ...
  <div class="b3-tab-container" style="height:85vh" data-name="editor">${editor.genHTML()}</div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="filetree"></div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="image"></div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="export"></div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="appearance"></div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="bazaar"></div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="search"></div>
  <div class="b3-tab-container fn__none" style="height:85vh;overflow: scroll" data-name="keymap"></div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="account"></div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="repos"></div>
  <div class="b3-tab-container fn__none" style="height:85vh" data-name="about"></div>
</div>
</div>`,
        width: "90vw",
    });
